...
protected:
     ...
     */
    virtual cpptempl::data_map makeGroupSymbolsTemplateData(Group *group) override;
     ...
     */
    virtual cpptempl::data_map getFunctionTemplateData(Group *group, Function *fn) override;
     ...
     * @return Contains interface function data.
     */
    virtual cpptempl::data_map getFunctionTypeTemplateData(Group *group, FunctionType *fn) override;
     ...
     */
    virtual void setTemplateComments(Symbol *symbol, cpptempl::data_map &symbolInfo) override;
     ...
     */
    virtual void generateOutputFiles(const std::string &fileNameExtension) override;
     ...
     */
    std::string generateParamWrite(StructMember *param, const std::string &paramName);
     ...
     */
    std::string generateTypeRead(DataType *dataType, const std::string &codecName);
     ...
     */
    std::string generateListItemWrite(DataType *elementType, const std::string &itemName);
     ...
     */
    std::string generateParamWriteForDataType(DataType *dataType, const std::string &paramName);
...
private:
     ...
     */
    std::string generateClientRequestSerialization(Function *fn, const std::vector<StructMember *> &inParams);
     ...
     */
    std::string generateClientResponseDeserialization(Function *fn, const std::vector<DataType *> &outParamTypes,
     ...
     */
    std::string generateOutParamRead(DataType *paramType, const std::string &paramName);
     ...
     */
    std::string getCodecNameForType(DataType *dataType, const std::string &baseCodecName);
     ...
     */
    std::string generateServerParameterDeserialization(Function *fn, const std::string &codecParamName);
     ...
     */
    std::string generateServerResponseSerialization(Function *fn, const std::string &codecParamName);
     ...
     */
    std::string generateServerErrorResponseSerialization(Function *fn, const std::string &codecParamName);
     ...
     */
    std::string generateTypeWrite(DataType *dataType, const std::string &variableName);
     ...
     */
    void determineReturnTypes(Function *fn, bool hasOutParams, const std::vector<DataType *> &outParamTypes,
     ...
     */
    std::string generateOnewayServerHandler(Function *fn, const std::string &codecParamName);
     ...
     * @return String with server handler code.
     */
    std::string generateRegularServerHandler(Function *fn, const std::string &codecParamName,
     ...
     */
    std::string generateMethodCallParameters(Function *fn, const std::set<std::string> &lengthParams);
     ...
     */
    std::string generateClientMethodCode(Function *fn, std::vector<DataType *> &outParamTypes, bool &hasOutParams);
     ...
     */
    std::string generateBuiltinTypeWrite(BuiltinType *builtinType, const std::string &codecName,
                                         const std::string &variableName, bool addErrorHandling = true);
     ...
     */
    std::string generateBuiltinTypeRead(BuiltinType *builtinType, const std::string &codecName);
     ...
     */
    std::string generateBuiltinTypeDefaultWrite(BuiltinType *builtinType, const std::string &codecName);
};
